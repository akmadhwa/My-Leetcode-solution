...
public class Solution_a {
	public static boolean nimWinner(int n) {
		return n % 4 != 0;
	}
	...
	public static void main(String[] args) {
		...
		int s =4;
		System.out.println(nimWinner(s));
	}

}
/**
 * 1. the base case: when n = 4, as suggested by the hint from the problem, no matter which number that that first player, 
...
4. Following the second case, for numbers between (2*4 = 8) and (3*4=12), which are 9, 10, 11, 
